...
//	Total marks in descending order................
    ...
    // ... (Your existing code to calculate total marks)

    // Store total marks in a separate array for sorting
    int sortedTotal[10];
    for (int i = 0; i < 10; i++) {
    ...
    // Display the sorted total marks along with Roll Numbers
//    cout << "Roll No" << setw(16) << "Total Marks" << endl;
    for (int i = 0; i < 10; i++) {
//        cout << " " << i + 1 << "." << setw(13) << sortedTotal[i] << endl;
    }
	
	
	cout << endl;
	cout << "________Main Menu_________" << endl << endl;
	...
	switch (option)
	{
		case 1:
			...
			cout<<"Roll No"<<setw(7)<<"Marks"<<endl;
			
			for (int i=0; i<=9; i++)
				{
			       cout<<i+1<<"."<<setw(10)<<num[i]<<endl; 
				}
			
			cout << "The maximum number is " << max << " of Roll.No " << j << " in OHT-01." << endl;
			cout << "The minimum number is " << min << " of Roll.No " << j2 << " in OHT-01."  << endl;
			cout << "The average of the class for OHT-01 is " << average1 << endl;
			break;
		...
		case 2:
			...
			for (int i=0; i<=9; i++)
				{
			       cout << i+1 << "." << setw(10) << num2[i] << endl; 
				}
				
			cout << "The maximum number is " << max2 << " of Roll.No " << pointer << " in OHT-02." << endl;
			cout << "The minimum number is " << min2<< " of Roll.No " << pointer2 << " in OHT-02."  << endl;
			cout << "The average of the class for OHT-02 is " << average2 << endl;
			break;
		...
		case 3:
			...
			for (int i=0; i<=9; i++)
				{
			       cout << i+1 << "." << setw(10) << quiz1[i] << endl; 
				}	
				
			cout << "The maximum number is " << quizMax << " of Roll.No " << k << " in Quiz-01." << endl;
			cout << "The minimum number is " << quizMin << " of Roll.No " << k2 << " in Quiz-01."  << endl;
			cout << "The average of the class for Quiz-01 is " << quizAverage1 << endl << endl;
			break;
		...
		case 4:
			...
			for (int i=0; i<=9; i++)
				{
			       cout << " " << i+1 << "." << setw(10) << quiz2[i] << endl; 
				}
				
			cout << "The maximum number is " << quizMax_2 << " of Roll.No " << v << " in Quiz-02." << endl;
			cout << "The minimum number is " << quizMin_2 << " of Roll.No " << v2 << " in Quiz-02."  << endl;
			cout << "The average of the class for Quiz-02 is " << quizAverage_2 << endl;
			break;
		...
		case 5:
			...
			for (int i=0; i<=9; i++)
				{
			       cout << " " << i+1 << "." << setw(10) << quiz3[i] << endl; 
				}
				
			cout << "The maximum number is " << quizMax_3 << " of Roll.No " << m << " in Quiz-03." << endl;
			cout << "The minimum number is " << quizMin_3 << " of Roll.No " << m2 << " in Quiz-03."  << endl;
			cout << "The average of the class for Quiz-03 is " << quizAverage_3 << endl;
			break;
		...
		case 6:
			...
			for (int i=0; i<=9; i++)
				{
			       cout << " " << i+1 << "." << setw(10) << quiz4[i] << endl; 
				}	
				
				cout << "The maximum number is " << quizMax_4 << " of Roll.No " << o << " in Quiz-04." << endl;
				cout << "The minimum number is " << quizMin_4 << " of Roll.No " << o2 << " in Quiz-04."  << endl;
				cout << "The average of the class for Quiz-04 is " << quizAverage_4 << endl;
				break;
		...
		case 7:
				...
				for (int i=0; i<=9; i++)
					{
			       		cout << " " << i+1 << "." << setw(10) << ass1[i] << endl; 
					}		
				
				cout << "The maximum number is " << assMax_1 << " of Roll.No " << p << " in Assignment-01." << endl;
				cout << "The minimum number is " << assMin_1 << " of Roll.No " << p2 << " in Assignment-01."  << endl;
				cout << "The average of the class for Assignment-01 is " << assAverage_1 << endl;
				break;	
		...
		case 8:
				...
				for (int i=0; i<=9; i++)
					{
			       		cout << " " << i+1 << "." << setw(10) << ass2[i] << endl; 
					}
					
				cout << "The maximum number is " << assMax_2 << " of Roll.No " << q << " in Assignment-02." << endl;
				cout << "The minimum number is " << assMin_2 << " of Roll.No " << q2 << " in Assignment-02."  << endl;
				cout << "The average of the class for Assignment-02 is " << assAverage_2 << endl;
				break;
		...
		case 12:
				...
				cout<<"Roll No"<<setw(8)<<"OHT-1" <<setw(8)<<"OHT-2" <<setw(8)<<"Quiz-1" <<setw(8)<<"Quiz-2" <<setw(8)<<"Quiz-3" <<setw(8)<<"Quiz-4" <<setw(8)<<"  Assignment-1" <<setw(8)<<"  Ass-2" <<setw(8)<< "  Project" <<setw(8)<<"Final" <<setw(8) << "Total"<<setw(8)<<"Grade"<<endl;
				...
				for (int i=0; i<=9; i++)
					{
						...
						cout << i+1 << "." << setw(10)<< num[i] << setw(10) << num2[i] << setw(8) << quiz1[i] << setw(8) << quiz2[i] << setw(8) << quiz3[i] << setw(8) << quiz4[i] << setw(8) << ass1[i] << setw(11) << ass2[i] << setw(10) << prj[i] << setw(9) << fnl[i] << setw(9)<< sortedTotal[i] << setw(8) << grade << endl;
					}	
